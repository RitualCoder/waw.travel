<div class="w-full relative">
  ...
  <section class="bg-home bg-center bg-no-repeat bg-cover h-auto md:h-60 lg:h-96">
    <div class="flex flex-col text-white justify-center items-center w-full h-full bg-filter py-4 gap-4 lg:gap-8 px-4 md:px-8 lg:px-16">
      <h1 class="font-second text-xl lg:text-4xl">Waw.travel</h1>
  ...
  <h2 class="font-medium text-center mb-2 text-lg font-second lg:text-2xl text-orange mt-6">Nos derniers ajouts</h2>
  <section class="grid pt-8 px-6 md:grid-cols-2 lg:grid-cols-3 md:gap-4 lg:gap-6 lg:px-12 xl:px-20 lg:pt-12">
